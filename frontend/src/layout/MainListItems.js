...
const useStyles = makeStyles((theme) => ({
  ...
  menuItem: {
    ...
    fontFamily: "'Inter', sans-serif",
    '&:hover': {
      backgroundColor: theme.mode === 'light' ? '#fdefff' : 'rgba(112, 0, 139, 0.1)',
    ...
    '&.Mui-selected': {
        backgroundColor: theme.mode === 'light' ? '#f7beff' : 'rgba(112, 0, 139, 0.2)',
        '& .MuiListItemIcon-root': {
          color: theme.palette.primary.main,
        },
        '& .MuiListItemText-primary': {
  ...
  menuIcon: {
    minWidth: 42,
    color: theme.mode === 'light' ? '#504251' : '#bbb',
  ...
  menuText: {
    '& .MuiListItemText-primary': {
      ...
      fontWeight: 500,
      fontFamily: "'Inter', sans-serif",
      color: theme.mode === 'light' ? '#211921' : '#eee',
    },
  },
  versionText: {
    fontSize: '10px',
