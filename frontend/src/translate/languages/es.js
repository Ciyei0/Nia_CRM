    ...
    translations: {
      ...
      connections: {
        ...
        confirmationModal: {
          ...
          disconnectMessage: "¿Estás seguro? Deberás volver a leer el código QR.",
        },
        buttons: {
        ...
        toolTips: {
          disconnected: {
            ...
            content: "Asegúrate de que tu teléfono esté conectado a internet e inténtalo nuevamente, o solicita un nuevo código QR",
          },
          qrcode: {
            title: "Esperando lectura del código QR",
            content: "Haz clic en el botón 'CÓDIGO QR' y lee el código QR con tu teléfono para iniciar sesión",
          },
          connected: {
      ...
      whatsappModal: {
        ...
        form: {
          ...
          queueRedirectionDesc: "Seleccione una cola para redirigir los contactos sin cola",
          prompt: "Prompt",
      ...
      queueIntegration: {
        ...
        confirmationModal: {
          deleteTitle: "Eliminar",
          deleteMessage: "¿Estás seguro? ¡Esta acción no se puede deshacer! y se eliminará de las colas y conexiones vinculadas",
        },
      },
      reports: {
      ...
      queues: {
        ...
        confirmationModal: {
          deleteTitle: "Eliminar",
          deleteMessage: "¿Estás seguro? ¡Esta acción no se puede deshacer! Los tickets de esta cola seguirán existiendo pero ya no tendrán ninguna cola asignada.",
        },
      },
      queueSelect: {
        inputLabel: "Colas",
